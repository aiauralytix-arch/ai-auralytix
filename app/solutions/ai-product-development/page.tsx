    ...
    <Container className="py-10 space-y-8">
      ...
      <div className="grid gap-8 md:grid-cols-2 items-center">
        ...
        <div className="rounded-2xl overflow-hidden border shadow-glass">
          <Image src="https://img.freepik.com/free-photo/person-working-animation-porject_23-2149269908.jpg" width={1200} height={800} alt="AI product development visualization" />
        </div>
      </div>
      <Timeline items={[
